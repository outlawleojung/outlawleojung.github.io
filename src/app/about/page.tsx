...
const intro =
  ...
  "클라우드 인프라 운영을 함께 다뤄왔으며, 현재는 팀 리드·아키텍트 역할에서 레거시 리뉴얼과 " +
  "신규 서비스 설계를 병행하고 있습니다. 최근에는 FastAPI + Claude API + pgvector 조합의 " +
  "RAG 챗봇 개발을 병행하며 LLM · 벡터 검색 스택도 다루고 있습니다.";
...
const sections: Array<{ heading: string; body: string }> = [
  {
    ...
    body:
      ...
      "이후 애니챗에서는 앱 서비스를 NestJS + PostgreSQL + Flutter로 리뉴얼하여 런칭했으며, " +
      "서비스 간 gRPC 통신과 Gateway 패턴을 도입했습니다. 현재 힐링샘에서는 PHP·Spring Boot로 " +
      "운영되던 14년+ 레거시 3개 서비스를 NestJS + Next.js + gRPC MSA로 무중단 전환하는 프로젝트를 " +
      "진행 중이며, DB per Service 구조에서의 데이터 정합성 확보 방안(Outbox · Saga · " +
      "Idempotency 등)을 설계 단계에서 함께 검토하고 있습니다. 이와 병행해 FastAPI · Claude API · " +
      "Voyage AI · pgvector 조합으로 사내 Q&A 데이터를 활용한 RAG 챗봇도 개발하고 있습니다.",
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      "기술 선정부터 설계·구현·배포·운영까지 전 과정을 직접 실행하고 있으며, " +
